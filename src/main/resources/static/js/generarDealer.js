...
var tituloBongalow=["Dealer Renzo","Dealer. B","Dealer. C","Dealer. D","Dealer. E.",
    "Dealer F.","Dealer G.","Dealer. h.","Dealer iojaois","Dealer Charles"];
var sedesBungalows=[[],[],[],[],[],[],[],[],[],[]];
...
function retornaSedes(sedes){
    if(sedes.length==0)return $('<p></p>').html("Dealer ID");
    else {
        var parrafo=$('<p></p>');
